  ...
  { 
	...
	int i;
    static double xr[7],xi[7];
    static double ar[8]={0.1,21.33,4.9,0.0,3.0,1.0,1.0,1.0};
    static double ai[8]={-100.0,0.0,-19.0,-0.01,2.0,0.0,1.0,1.0};
    i=dcsrt(ar,ai,7,xr,xi);
    printf("\n");
    if (i>0)
      { for (i=0; i<=6; i++)
